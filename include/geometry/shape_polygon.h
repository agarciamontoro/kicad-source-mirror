...
public:
    ...
    public:
        ...
        T& Get()
        {
            return m_poly->Contour( m_currentContour ).Point( m_currentVertex );
        }
     ...
     * @param  aGlobalIdx is the global index of the vertex that shall be found.
     * @return VERTEX_INDEX - the contour and vertex indices of the corner globally indexed
     *                      as \p aGlobalIdx.
     */
    VERTEX_INDEX GetVertexIndex( int aGlobalIdx );
private:
    /**
     * Function importNode
